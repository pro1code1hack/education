...
from education.settings import STUDENT, TEACHER, SCORE_CHOICES
...
class GroupStudent(models.Model):
    ...
    subjects = models.ManyToManyField('educational_institution.Subject')
    # teachers = models.ManyToManyField('staff.Teacher', blank=True, null=True) #TODO переделать потом
    university = models.ForeignKey('educational_institution.University', on_delete=models.CASCADE, blank=True, null=True)
